...
# result_save_path = "./result"  # 保存结果的路径
# summary_save_path = "./summary"  # 添加这一行避免变量未定义
# enable_summary = True  # 控制是否生成 summary
...
class ProteinClassifier:
    ...
    def predict_genome(self, fasta_file, result_save_path, min_confidence=0.7, min_protein_length=100, molecule_type='DNA'):
        ...
        for record in SeqIO.parse(fasta_file, "fasta"):
            ...
            # if True:
            #     summary_output = ""
            #     for content in generate_summary_stream(record.id, output, savepath='./summary'):
